...
lss=[]
f=open('/home/zr/ee/PycharmProjects/allitems/test.txt' , 'r')
for line in f.xreadlines():
    lss.append(line)
f.close()
print (lss)

file=codecs.open('/home/zr/ee/PycharmProjects/allitems/query.txt' , 'w',encoding='utf-8')
file.close()
...
def main(argv):
    ...
    input_dir='/home/zr/ee/PycharmProjects/allitems/allitems/dombapic/'
    input_dir1='/home/zr/ee/PycharmProjects/allitems/allitems/glbapic'
    try:
        ...
        if near_duplicates:
            ...
            for a,b,s in near_duplicates:
                if(a==str(lss[0]) or b==str(lss[0])):
                    ...
                    f=open('/home/zr/ee/PycharmProjects/allitems/allitems/sinadombaimg.txt' , 'r')
                    opp=[]
                    for line in f.xreadlines():
                    ...
                    if(a!=str(lss[0])):
                        ...
                        i = i.split(".")[0]
                        print int(i)
                        file=codecs.open('/home/zr/ee/PycharmProjects/allitems/allitems/query.txt' , 'a' ,encoding='utf-8')
    ...
    try:
        ...
        if near_duplicates:
            ...
            for a,b,s in near_duplicates:
                if(a==str(lss[0]) or b==str(lss[0])):
                    print "{} similarity: file 1: {} - file 2: {}".format(s,a,b)
                    f=open('/home/zr/ee/PycharmProjects/allitems/allitems/sinaglbaimg.txt' , 'r')
                    opp=[]
                    for line in f.xreadlines():
                        op = re.split(r"(\*my_sep\*)",line)
                        op.append("")
